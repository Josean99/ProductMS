...
{
    Task Handle(Message<object> message, CancellationToken cancellationToken = default);
}
...
public class HandleMessage : IHandleMessage
{
    ...
    public Task Handle(Message<object> message, CancellationToken cancellationToken = default)
    {
